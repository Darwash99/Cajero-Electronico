                ...
                >
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        ...
                        <template v-else>
                            <Link
                                :href="route('login')"
                                class="rounded-md px-3 py-2 text-white ring-1 ring-transparent transition hover:text-white/70 focus:outline-none focus-visible:ring-[#ffff] white:text-white white:hover:text-white/80 white:focus-visible:ring-white"
                            >
                                Ingresar
                            </Link>
